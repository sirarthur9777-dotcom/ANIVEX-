...
export const initialInvoices: InvoiceRecord[] = [
  {
    id: 'inv-1001',
    invoiceNumber: 'ANX-INV-2026-996',
    ...
    clientName: 'Ramdas Chauhan',
    clientCompany: 'Shaurya Jan Sewa Kendra',
    clientEmail: 'shauryacsp@gmail.com',
    clientPhone: '+91 7488733181',
    clientAddress: 'Babhnauli, Damarua, Jaunpur – 222135, Uttar Pradesh, India',
